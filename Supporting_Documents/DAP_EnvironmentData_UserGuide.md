...
Successfully geocoded respondent addresses are linked to pre-existing environmental indicators. The following four sections describe the contextual variables linked to geocoded respondent addresses. 
...
This yields a total of 48 global summaries of the month variables (12 months * 4 variables) as well as 48 normals monthly variables, resulting in 96 total substantive contextual climate variables linked to residential primary and secondary addresses. 
